...
import { PromiseItem, UpdateItem, EvidenceItem, CommentItem, PromiseStatus, PromisePriority } from "@/types";
...
export default function PromiseDetailPage({ params }: PageProps) {
  const { id } = use(params);
